...
const Error = ({ message, setError }) => {
  return (
    <div
      className="alert alert-danger alert-dismissible text-center fade show d-flex align-items-center position-fixed top-0 start-50 translate-middle-x col-11 col-md-6 p-3 mt-3"
      style={{ zIndex: 1050 }}
      role="alert"
    >
