...
const Address = ({ name, addressLine1, addressLine2, city, postcode, addressId, isDefault, handleAddressDelete, handleSetDefault }) => {
  return (
    // Address component
        ...
        <div className="card-body d-flex row">
          ...
          <div className="mt-auto">
            <div className="d-flex justify-content-start">
              ...
              <button className="btn btn-outline-danger ms-2 rounded-0" onClick={handleAddressDelete}>
                Delete
              </button>
              {isDefault ? (
                ""
              ) : (
                <button className="btn btn-outline-primary ms-2 rounded-0" onClick={handleSetDefault}>
                  Set as Default
                </button>
              )}
            </div>
