...
const About = () => {
  return (
    <section id="about" className="position-relative vh-100">
      <div className="d-flex position-relative about-bg-image">
        {/* Dark overlay, zIndex used to position homepage content above the overlay */}
        <div className="position-absolute top-0 start-0 w-100 h-100 bg-dark bg-opacity-50"></div>

        <div className="container d-flex flex-column align-items-start justify-content-center position-relative">
